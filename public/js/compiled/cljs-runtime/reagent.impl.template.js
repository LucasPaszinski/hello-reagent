...
var G__38640 = o;
(G__38640[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__38642){
var map__38643 = p__38642;
var map__38643__$1 = cljs.core.__destructure_map(map__38643);
var props = map__38643__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38643__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__38644){
var map__38645 = p__38644;
var map__38645__$1 = cljs.core.__destructure_map(map__38645);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38645__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__38649){
var map__38650 = p__38649;
var map__38650__$1 = cljs.core.__destructure_map(map__38650);
var synthetic_on_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38650__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38650__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
...
var G__38651 = jsprops;
(G__38651["defaultValue"] = value);

(G__38651["onChange"] = (function (p1__38646_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change__$1,p1__38646_SHARP_);
}));
...
var vec__38653 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38653,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38653,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38653,(2),null);
...
var jsprops = ({"argv": v});
var temp__5757__auto___38683 = reagent.impl.template.key_from_vec(v);
if((temp__5757__auto___38683 == null)){
} else {
var key_38684 = temp__5757__auto___38683;
(jsprops["key"] = key_38684);
}
...
(reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__38659){
var map__38660 = p__38659;
var map__38660__$1 = cljs.core.__destructure_map(map__38660);
var synthetic_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38660__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__38661 = reagent.impl.template.__GT_NativeWrapper();
(G__38661["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__38662 = wrapped;
(G__38662["syntheticInput"] = true);

return G__38662;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__38663 = wrapped__$1;
(G__38663["syntheticOnChange"] = on_change);

return G__38663;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__38664 = wrapped__$2;
(G__38664["syntheticOnUpdate"] = on_update);
...
if(cljs.core.truth_((function (){var or__4253__auto__ = synthetic_input;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq38668){
var G__38669 = cljs.core.first(seq38668);
var seq38668__$1 = cljs.core.next(seq38668);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38669,seq38668__$1);
}));
...
break;
default:
var G__38695 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__38695;
continue;
...
var n__4741__auto___38700 = a.length;
var i_38701 = (0);
while(true){
if((i_38701 < n__4741__auto___38700)){
(a[i_38701] = reagent.impl.template.as_element((a[i_38701])));

var G__38702 = (i_38701 + (1));
i_38701 = G__38702;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4741__auto___38703 = a.length;
var i_38704 = (0);
while(true){
if((i_38704 < n__4741__auto___38703)){
var val_38705 = (a[i_38704]);
if(((cljs.core.vector_QMARK_(val_38705)) && ((reagent.impl.template.key_from_vec(val_38705) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_38704] = reagent.impl.template.as_element(val_38705));

var G__38706 = (i_38704 + (1));
i_38704 = G__38706;
continue;
} else {
}
...
var ctx = ({});
var vec__38672 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38672,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38672,(1),null);
...
var G__38675 = (cljs.core.count(argv) - first_child);
switch (G__38675) {
case (0):
