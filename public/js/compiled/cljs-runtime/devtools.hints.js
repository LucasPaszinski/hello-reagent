...
var map__28700 = top_item;
var map__28700__$1 = cljs.core.__destructure_map(map__28700);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28700__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28700__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28700__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e28697){var _e = e28697;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___28765 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5751__auto___28765)){
var seen_errors_28770 = temp__5751__auto___28765;
if(cljs.core.truth_(seen_errors_28770.has(self))){
} else {
seen_errors_28770.add(self);

var temp__5753__auto___28774 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5753__auto___28774)){
var sense_28775 = temp__5753__auto___28774;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_28775)].join(''));
} else {
}
}
} else {
