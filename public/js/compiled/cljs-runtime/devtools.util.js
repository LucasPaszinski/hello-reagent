...
var len__4864__auto___29724 = arguments.length;
var i__4865__auto___29725 = (0);
while(true){
if((i__4865__auto___29725 < len__4864__auto___29724)){
args__4870__auto__.push((arguments[i__4865__auto___29725]));

var G__29726 = (i__4865__auto___29725 + (1));
i__4865__auto___29725 = G__29726;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__29593_29727 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__29594_29728 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__29595_29729 = true;
var _STAR_print_fn_STAR__temp_val__29596_29730 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__29595_29729);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__29596_29730);

try{var _STAR_print_level_STAR__orig_val__29597_29731 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29598_29732 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29598_29732);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29597_29731);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__29594_29728);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__29593_29727);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq29590){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq29590));
}));
...
var new_formatters = current_formatters.filter((function (p1__29656_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__29656_SHARP_)));
}));
...
var G__29660_29745 = f;
var target__27369__auto___29746 = G__29660_29745;
if(cljs.core.truth_(target__27369__auto___29746)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29660_29745)].join(''),"\n","target__27369__auto__"].join('')));
}

(target__27369__auto___29746["toString"] = (function (){
...
var G__29667_29751 = "%c%s";
var G__29668_29752 = "color:transparent";
var G__29669_29753 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__29667_29751,G__29668_29752,G__29669_29753) : f.call(null,G__29667_29751,G__29668_29752,G__29669_29753));
...
var args__4870__auto__ = [];
var len__4864__auto___29755 = arguments.length;
var i__4865__auto___29756 = (0);
while(true){
if((i__4865__auto___29756 < len__4864__auto___29755)){
args__4870__auto__.push((arguments[i__4865__auto___29756]));

var G__29757 = (i__4865__auto___29756 + (1));
i__4865__auto___29756 = G__29757;
continue;
} else {
}
break;
...
var vec__29689 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29689,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29689,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__29763__delegate = function (add_fmt,add_args){
...
var G__29763 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__29764__i = 0, G__29764__a = new Array(arguments.length -  1);
while (G__29764__i < G__29764__a.length) {G__29764__a[G__29764__i] = arguments[G__29764__i + 1]; ++G__29764__i;}
  add_args = new cljs.core.IndexedSeq(G__29764__a,0,null);
} 
return G__29763__delegate.call(this,add_fmt,add_args);};
G__29763.cljs$lang$maxFixedArity = 1;
G__29763.cljs$lang$applyTo = (function (arglist__29765){
var add_fmt = cljs.core.first(arglist__29765);
var add_args = cljs.core.rest(arglist__29765);
return G__29763__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq29684){
var G__29685 = cljs.core.first(seq29684);
var seq29684__$1 = cljs.core.next(seq29684);
var G__29686 = cljs.core.first(seq29684__$1);
var seq29684__$2 = cljs.core.next(seq29684__$1);
var G__29687 = cljs.core.first(seq29684__$2);
var seq29684__$3 = cljs.core.next(seq29684__$2);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29685,G__29686,G__29687,seq29684__$3);
}));
...
var seq__29705 = cljs.core.seq(features);
var chunk__29706 = null;
var count__29707 = (0);
var i__29708 = (0);
while(true){
if((i__29708 < count__29707)){
var feature = chunk__29706.cljs$core$IIndexed$_nth$arity$2(null,i__29708);
...
var G__29767 = seq__29705;
var G__29768 = chunk__29706;
var G__29769 = count__29707;
var G__29770 = (i__29708 + (1));
seq__29705 = G__29767;
chunk__29706 = G__29768;
count__29707 = G__29769;
i__29708 = G__29770;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__29705);
if(temp__5753__auto__){
var seq__29705__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__29705__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__29705__$1);
var G__29771 = cljs.core.chunk_rest(seq__29705__$1);
var G__29772 = c__4679__auto__;
var G__29773 = cljs.core.count(c__4679__auto__);
var G__29774 = (0);
seq__29705 = G__29771;
chunk__29706 = G__29772;
count__29707 = G__29773;
i__29708 = G__29774;
continue;
} else {
var feature = cljs.core.first(seq__29705__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__29775 = cljs.core.next(seq__29705__$1);
var G__29776 = null;
var G__29777 = (0);
var G__29778 = (0);
seq__29705 = G__29775;
chunk__29706 = G__29776;
count__29707 = G__29777;
i__29708 = G__29778;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5751__auto__)){
var o29719 = temp__5751__auto__;
return (o29719["version"]);
} else {
return null;
}
})() == null);
