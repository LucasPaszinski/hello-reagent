...
var i_32844 = (0);
while(true){
if((i_32844 < arr.length)){
(arr[i_32844] = null);

var G__32845 = (i_32844 + (1));
i_32844 = G__32845;
continue;
} else {
}
...
var i_32859 = (self__.level + (1));
while(true){
if((i_32859 <= (new_level + (1)))){
(update[i_32859] = self__.header);

var G__32860 = (i_32859 + (1));
i_32859 = G__32860;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_32862 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_32862[i]));
} else {
x__$2.forward.push((((i < links_32862.length))?(links_32862[i]):null));
}

if((i < links_32862.length)){
(links_32862[i] = x__$2);
} else {
links_32862.push(x__$2);
}
...
var i_32870 = (0);
while(true){
if((i_32870 <= self__.level)){
var links_32871 = (update[i_32870]).forward;
if((x__$1 === (((i_32870 < links_32871.length))?(links_32871[i_32870]):null))){
(links_32871[i_32870] = (x__$1.forward[i_32870]));

var G__32872 = (i_32870 + (1));
i_32870 = G__32872;
continue;
} else {
var G__32873 = (i_32870 + (1));
i_32870 = G__32873;
continue;
}
} else {
...
var G__32877 = nx;
var G__32878 = (level__$1 - (1));
x = G__32877;
level__$1 = G__32878;
continue;
} else {
var G__32880 = x;
var G__32881 = (level__$1 - (1));
x = G__32880;
level__$1 = G__32881;
continue;
}
