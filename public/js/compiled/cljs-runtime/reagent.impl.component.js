...
if((i < len)){
var k = (ks[i]);
var G__38628 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__38629 = (i + (1));
m = G__38628;
i = G__38629;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38537 = c;
var G__38537__$1 = (((G__38537 == null))?null:G__38537.prototype);
if((G__38537__$1 == null)){
return null;
} else {
return (G__38537__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38540 = c;
var G__38540__$1 = (((G__38540 == null))?null:G__38540.prototype);
if((G__38540__$1 == null)){
return null;
} else {
return (G__38540__$1["render"]);
}
})() == null)))));
});
...
var G__38548 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__38548) : reagent.impl.component.as_element.call(null,G__38548));
};
...
while (G__38632__i < G__38632__a.length) {G__38632__a[G__38632__i] = arguments[G__38632__i + 0]; ++G__38632__i;}
  args = new cljs.core.IndexedSeq(G__38632__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__38550 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38551 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38551);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38550);
}});
...
var G__38585 = key;
var G__38585__$1 = (((G__38585 instanceof cljs.core.Keyword))?G__38585.fqn:null);
switch (G__38585__$1) {
...
var c = this;
var G__38609_38636 = (c["cljsRatom"]);
if((G__38609_38636 == null)){
} else {
reagent.ratom.dispose_BANG_(G__38609_38636);
}
...
var renders_38637 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_38638 = cljs.core.first(cljs.core.vals(renders_38637));
if((cljs.core.count(renders_38637) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_38637))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_38638)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_38638], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var render_fun__$1 = (function (){var or__4253__auto__ = render_fun;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
var name = cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__4253__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
var name__$1 = (function (){var G__38617 = name;
switch (G__38617) {
case "":
...
var name = (function (){var G__38619 = fiber;
var G__38619__$1 = (((G__38619 == null))?null:(G__38619["type"]));
if((G__38619__$1 == null)){
return null;
} else {
return (G__38619__$1["displayName"]);
}
})();
var parent = (function (){var G__38620 = fiber;
if((G__38620 == null)){
return null;
} else {
return (G__38620["return"]);
}
})();
var path = (function (){var G__38621 = parent;
var G__38621__$1 = (((G__38621 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__38621) : reagent.impl.component.fiber_component_path.call(null,G__38621)));
if((G__38621__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38621__$1)," > "].join('');
}
})();
...
var temp__5751__auto__ = (function (){var G__38622 = c;
if((G__38622 == null)){
return null;
} else {
return (G__38622["_reactInternalFiber"]);
}
})();
...
var elem = (function (){var G__38623 = (function (){var or__4253__auto__ = (function (){var G__38624 = c;
if((G__38624 == null)){
return null;
} else {
return (G__38624["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
return (G__38623["_currentElement"]);
}
})();
var name = (function (){var G__38625 = elem;
var G__38625__$1 = (((G__38625 == null))?null:(G__38625["type"]));
if((G__38625__$1 == null)){
return null;
} else {
return (G__38625__$1["displayName"]);
}
})();
var path = (function (){var G__38626 = elem;
var G__38626__$1 = (((G__38626 == null))?null:(G__38626["_owner"]));
var G__38626__$2 = (((G__38626__$1 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__38626__$1) : reagent.impl.component.component_path.call(null,G__38626__$1)));
if((G__38626__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38626__$2)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__38627 = c;
var G__38627__$1 = (((G__38627 == null))?null:G__38627.constructor);
if((G__38627__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__38627__$1);
}
}
})();
