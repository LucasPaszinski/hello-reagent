...
var G__29024 = devtools.prefs.pref(v);
v = G__29024;
continue;
} else {
return v;
...
}catch (e28971){var _e__27377__auto__ = e28971;
return false;
}})();
...
}catch (e28976){var _e__27377__auto__ = e28976;
return false;
}})();
...
}catch (e28980){var _e__27377__auto__ = e28980;
return false;
}}
}
});
...
var vec__28996 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28996,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28996,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__29006_SHARP_);
}),template);
});
