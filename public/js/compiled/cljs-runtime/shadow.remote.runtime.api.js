...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_32999 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_32999(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_33001 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_33001(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_33002 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_33002(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_33003 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_33003(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33010 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33010(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_33012 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_33012(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__32997,callback){
var map__32998 = p__32997;
var map__32998__$1 = cljs.core.__destructure_map(map__32998);
var input = map__32998__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32998__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32998__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
